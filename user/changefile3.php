...
if (isset($_POST['submit'])) {
    ...
    $allowed_extensions3 = array(".pdf");

    if (!in_array($extension3, $allowed_extensions3)) {
        $_SESSION['error_msg'] = "Invalid file format. Only PDF allowed.";
        header("Location: edit-notes.php?editid=$eid");
        exit();
    } else {
        $newFile3Name = md5($file3) . time() . $extension3;
        move_uploaded_file($_FILES["file3"]["tmp_name"], "folder3/" . $newFile3Name);

        $sql = "UPDATE tblnotes SET File3=:file3 WHERE ID=:eid";
        $query = $dbh->prepare($sql);
        $query->bindParam(':file3', $newFile3Name, PDO::PARAM_STR);
        ...
        <div class="col-sm-12 col-xl-6">
            <div class="bg-light rounded h-100 p-4">
                ...
                ?>
                    ...
                    <div class="mb-3">
                        <label class="form-label">View Old File3</label>
                        <a href="folder3/<?php echo $row->File3;?>">
